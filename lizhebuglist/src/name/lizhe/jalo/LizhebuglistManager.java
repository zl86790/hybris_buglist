...
/**
 * This is the extension manager of the Lizhebuglist extension.
 */
public class LizhebuglistManager extends GeneratedLizhebuglistManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(LizhebuglistManager.class);
	 ...
	 */
	public static LizhebuglistManager getInstance()
	{
		return (LizhebuglistManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(LizhebuglistConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LizhebuglistManager() // NOPMD 
	{
		LOG.debug("constructor of LizhebuglistManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of LizhebuglistManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of LizhebuglistManager called, current tenant: {}", getTenant().getTenantID());
	}
