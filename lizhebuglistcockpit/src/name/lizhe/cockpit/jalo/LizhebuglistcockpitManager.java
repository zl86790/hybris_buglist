...
/**
 * This is the extension manager of the lizhebuglistcockpit extension.
 */
public class LizhebuglistcockpitManager extends GeneratedLizhebuglistcockpitManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(LizhebuglistcockpitManager.class.getName());
	 ...
	 */
	public static final LizhebuglistcockpitManager getInstance()
	{
		return (LizhebuglistcockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(LizhebuglistcockpitConstants.EXTENSIONNAME);
	}
